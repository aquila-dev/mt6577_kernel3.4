...
static PVRSRV_ERROR SysLocateDevices(SYS_DATA *psSysData)
{
	...
	gsSGXDeviceMap.ui32RegsSize = SYS_MT6577_SGX_REGS_SIZE;
...
#else	
	gsSGXDeviceMap.sRegsSysPBase.uiAddr = SYS_MT6577_SGX_REGS_SYS_PHYS_BASE;
	gsSGXDeviceMap.sRegsCpuPBase = SysSysPAddrToCpuPAddr(gsSGXDeviceMap.sRegsSysPBase);
	gsSGXDeviceMap.ui32RegsSize = SYS_MT6577_SGX_REGS_SIZE;

	gsSGXDeviceMap.ui32IRQ = SYS_MT6577_SGX_IRQ;
...
//	}
	...
	if(gsSGXRegsCPUVAddr != IMG_NULL)
	{
		...
		OSBaseFreeContigMemory(SYS_MT6577_SGX_REGS_SIZE, gsSGXRegsCPUVAddr, gsSGXDeviceMap.sRegsCpuPBase);
#else
#if defined(SGX_OCP_REGS_ENABLED)
