...
extern bool mt6577_nand_exec_read_page_hw(struct nand_chip *nand, u32 page, u32 page_size, u8 *dat, u8 *oob);
extern bool nand_block_bad_hw(struct nand_chip *nand, u32 offset);

#elif defined(__KERNEL_NAND__)

extern bool mt6577_nand_exec_read_page(struct mtd_info *mtd, u32 row, u32 page_size, u8 *dat, u8 *oob);
extern int mt6577_nand_block_bad_hw(struct mtd_info *mtd, loff_t ofs);
extern int mt6577_nand_erase_hw(struct mtd_info *mtd, int page);
extern int mt6577_nand_block_markbad_hw(struct mtd_info *mtd, loff_t ofs);
extern int mt6577_nand_exec_write_page(struct mtd_info *mtd, u32 row, u32 page_size, u8 *dat, u8 *oob);
