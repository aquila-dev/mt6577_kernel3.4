...
//    if (request_irq(MT6577_SMI_LARB1_VAMAU_IRQ_ID, (irq_handler_t)MT6573FDVT_irq, 0, FDVT_DEVNAME, NULL) < 0)
    if (request_irq(MT6577_SMI_LARB1_VAMAU_IRQ_ID, (irq_handler_t)MT6573FDVT_irq, IRQF_TRIGGER_LOW, FDVT_DEVNAME, NULL) < 0)
    {
    ...
    // mt65xx_irq_unmask(MT6577_SMI_LARB1_VAMAU_IRQ_ID);
    // enable_irq(MT6577_SMI_LARB1_VAMAU_IRQ_ID);
