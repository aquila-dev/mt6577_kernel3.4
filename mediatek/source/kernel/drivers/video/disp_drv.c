...
BOOL DISP_EsdRecover(void)
{
    ...
    //hupeng 0503,update the screen when recover from ESD
    #ifdef HQ_LCD_ESD_CHECK
    printk("DISP_EsdRecover end, to call DISP_UpdateScreen \n");
    DISP_UpdateScreen(0,0,540,960);
    printk("DISP_UpdateScreen end \n");
    #endif
    return result;
}
