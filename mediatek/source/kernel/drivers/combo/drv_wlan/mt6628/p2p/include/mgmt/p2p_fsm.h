/*
** $Id: //Department/DaVinci/TRUNK/WiFi_P2P_Driver/include/mgmt/p2p_fsm.h#73 $
*/
 ...
 * 03 05 2012 terry.wu
 * NULL
 * Sync CFG80211 modification for ICS from branch 2.2.
 *
 * 02 24 2012 yuche.tsai
 * NULL
 * Fix GO disolved issue.
 *
 * 02 22 2012 yuche.tsai
 * NULL
 * Solve sigma test 5.1.3 issue, assoc response should have P2P IE.
 *
 * 02 11 2012 yuche.tsai
 * NULL
 * Modify Beacon & Probe Response policy for P2P network.
 *
